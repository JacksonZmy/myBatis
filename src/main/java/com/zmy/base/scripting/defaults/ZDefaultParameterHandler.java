 ...
 */
public class ZDefaultParameterHandler implements ZParameterHandler {
  ...
  public ZDefaultParameterHandler(ZMappedStatement mappedStatement, Object parameterObject, ZBoundSql boundSql) {
  ...
  public void setParameters(PreparedStatement ps) {
    ...
    if (parameterMappings != null) {
      for (int i = 0; i < parameterMappings.size(); i++) {
        ZParameterMapping parameterMapping = parameterMappings.get(i);
