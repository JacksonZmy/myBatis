...
public final class ZTypeHandlerRegistry {
     ...
     */
    public ZTypeHandlerRegistry() {
        this(new ZConfiguration());
    }
     ...
     * @since 3.5.4
     */
    public ZTypeHandlerRegistry(ZConfiguration configuration) {
    this.unknownTypeHandler = new ZUnknownTypeHandler(configuration);
