...
public class ZUnknownTypeHandler extends BaseTypeHandler<Object> {
    ...
    private final Supplier<ZTypeHandlerRegistry> typeHandlerRegistrySupplier;
     ...
     * @since 3.5.4
     */
    public ZUnknownTypeHandler(ZConfiguration configuration) {
     ...
     */
    @Deprecated
    public ZUnknownTypeHandler(ZTypeHandlerRegistry typeHandlerRegistry) {
        this.config = new ZConfiguration();
