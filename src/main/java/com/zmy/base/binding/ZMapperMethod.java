...
//                result = sqlSession.flushStatements();
    ...
    public static class MethodSignature {
        ...
        public ZResultHandler extractResultHandler(Object[] args) {
            return hasResultHandler() ? (ZResultHandler) args[resultHandlerIndex] : null;
        }
    ...
    private void executeWithResultHandler(ZSqlSession sqlSession, Object[] args) {
        // 获取SQL语句对应的 MappedStatement 对象
        ZMappedStatement ms = sqlSession.getConfiguration().getMappedStatement(command.getName());
    ...
    private <E> Object executeForMany(ZSqlSession sqlSession, Object[] args) {
        List<E> result;
        Object param = method.convertArgsToSqlCommandParam(args);
    ...
    private <E> Object convertToDeclaredCollection(ZConfiguration config, List<E> list) {
